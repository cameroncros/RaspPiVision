...
#define CMD_BUILDDT    0x1E // <ID>
#define CMD_ENDSTOP    0x1F // <ID> <type> <timeA> <timeB>
#define CMD_REFLASH    0x20 // Upload new image 
#define CMD_SHORTHOT   0x21 // <ID> <short> 
#define CMD_SETBAUD    0x22 // 18 81 <baud>
#define CMD_QUAD       0x23 // Quadrature encoder on 
#define CMD_QUAD_READ  0x24 // Get value
#define CMD_QUAD_GOTO  0x25 // Goto position
#define CMD_QUAD_LIMIT 0x26 // Set limits 
...
#define MOT_MODE_QUAD        0x03 // Quadrature encoder 
...
// Attention output signal mode
#define ATT_NONE       0x00
#define ATT_STEP_DONE  0x01
#define ATT_HIGH_QUEUE 0x02

// Quadrature encoder flags 
#define QUAD_EMPTY     0x00 // No flags
#define QUAD_REVERSE   0x01 // Reverse counting
#define QUAD_GOSLOW    0x02 // GOTO & limits have slow
#define QUAD_TOP       0x04 // Have top limit
#define QUAD_BOT       0x08 // Have bottom limit
#define QUAD_ON        0x10 // ON/OFF only used in command
#define QUAD_GOTO      0x80 // GOTO in operation 
#define QUAD_CLRFLGS   0x7F // Clear GOTO flag  
...
#define CMD_CL1A 5 // 1A <id> <repeat> <preamble> <dc_ms> <dc_ls>
#define CMD_CL1B 1
#define CMD_CL1C 1
#define CMD_CL1D 3
#define CMD_CL1E 0 // disabled 
#define CMD_CL1F 4 // 1F ID TYPE TIME TIME
#define CMD_CL20 3
#define CMD_CL21 2
#define CMD_CL22 3 // 22 18 81 <baud>
#define CMD_CL23 5 // QUAD [A0 23] id flgs posms posmm posls 
#define CMD_CL24 1 // QUAD read
#define CMD_CL25 6 // QUAD goto [A0 25] id goms gomm gols spms spls  
#define CMD_CL26 12 // [A0 26] id flags maxms maxmm maxls minms minmm minls distms distls dcms dcls
#define CMD_CL27 0
#define CMD_CL28 0
#define CMD_CL29 0
#define CMD_CL2A 0
