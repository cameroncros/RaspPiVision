...
int set_baud_rate(int port,int b)
{
  struct termios options;
  if (uart0_filestream == -1)
  {
    fprintf(stderr,"UART not open, can't set baudrate\n");
    fflush(stderr);
    return 0;
  }
  ...
  if (b<0 || b>4)
  {
    fprintf(stderr,"set_baud_rate: illegal baudrate\n");
    fflush(stderr);
    return 0;
  }
  ...
  switch (b)
  {
  case 0 : cfsetospeed(&options,B19200);
           cfsetispeed(&options,B19200);
           break;
  case 1 : cfsetospeed(&options,B38400);
           cfsetispeed(&options,B38400);
           break;
  case 2 : cfsetospeed(&options,B57600);
           cfsetispeed(&options,B57600);
           break;
  case 3 : cfsetospeed(&options,B115200);
           cfsetispeed(&options,B115200);
           break;
  case 4 : cfsetospeed(&options,B230400);
